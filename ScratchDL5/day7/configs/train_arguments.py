...
def get_arguments():
    ...
    parser.add_argument('--num_labels', type=int, default=10, help='Number of labels for conditional generation')
    ...
    #================= parser with guidance hyperparmeter  ===========================# 
    parser.add_argument('--gamma', type=float, default=3.0, help='Guidance Strength Parameter')
